...
#ifndef BABYTOWN_SWIFT_H
#define BABYTOWN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BabyTown",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8BabyTown11AppDelegate")
...
SWIFT_CLASS("_TtC8BabyTown24BabyTownCameraController")
@interface BabyTownCameraController : NSObject <AVCaptureFileOutputRecordingDelegate, AVCapturePhotoCaptureDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8BabyTown21CameraLocationManager")
@interface CameraLocationManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class CLLocationManager;
@class CLLocation;
@interface CameraLocationManager (SWIFT_EXTENSION(BabyTown)) <CLLocationManagerDelegate>
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (void)locationManagerDidChangeAuthorization:(CLLocationManager * _Nonnull)manager;
@end

@class NSCoder;
SWIFT_CLASS("_TtC8BabyTown22CameraPreviewContainer")
@interface CameraPreviewContainer : UIView
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC8BabyTown26CustomCameraViewController")
...
@interface CustomCameraViewController (SWIFT_EXTENSION(BabyTown)) <AVCapturePhotoCaptureDelegate>
- (void)captureOutput:(AVCapturePhotoOutput * _Nonnull)output didFinishProcessingPhoto:(AVCapturePhoto * _Nonnull)photo error:(NSError * _Nullable)error;
@end

/// A group of memory annotations rendered as a single count marker.
/// Unlike <code>MKClusterAnnotation</code>, these are produced by us (not MapKit) so the grouping is
...
SWIFT_CLASS("_TtC8BabyTown23MemoryClusterAnnotation")
@interface MemoryClusterAnnotation : NSObject <MKAnnotation>
@property (nonatomic, readonly) CLLocationCoordinate2D coordinate;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC8BabyTown19MemoryMapAnnotation")
@interface MemoryMapAnnotation : NSObject <MKAnnotation>
@property (nonatomic, readonly) CLLocationCoordinate2D coordinate;
...
SWIFT_CLASS("_TtC8BabyTown29MemoryMapMarkerAnnotationView")
@interface MemoryMapMarkerAnnotationView : MKMarkerAnnotationView
...
/// existing <code>MemoryMapMarkerAnnotationView</code> count marker instead.
SWIFT_CLASS("_TtC8BabyTown21MemoryPhotoMarkerView")
@interface MemoryPhotoMarkerView : MKAnnotationView
@property (nonatomic, strong) id <MKAnnotation> _Nullable annotation;
- (nonnull instancetype)initWithAnnotation:(id <MKAnnotation> _Nullable)annotation reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE;
- (void)layoutSubviews;
...
SWIFT_CLASS("_TtC8BabyTown26MemoryPlaceSearchViewModel")
@interface MemoryPlaceSearchViewModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class MKLocalSearchCompleter;
@interface MemoryPlaceSearchViewModel (SWIFT_EXTENSION(BabyTown)) <MKLocalSearchCompleterDelegate>
...
SWIFT_CLASS("_TtC8BabyTown19NotificationManager")
...
/// skin, or a named image). Idle/stand frames use the <code>stand_*</code> atlas prefix.
SWIFT_CLASS("_TtC8BabyTown12PetRoomScene")
@interface PetRoomScene : SKScene
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8BabyTown12VibeRecorder")
@interface VibeRecorder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVAudioRecorder;
@interface VibeRecorder (SWIFT_EXTENSION(BabyTown)) <AVAudioRecorderDelegate>
- (void)audioRecorderEncodeErrorDidOccur:(AVAudioRecorder * _Nonnull)recorder error:(NSError * _Nullable)error;
@end

SWIFT_CLASS("_TtC8BabyTown13VoiceRecorder")
@interface VoiceRecorder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVAudioPlayer;
@interface VoiceRecorder (SWIFT_EXTENSION(BabyTown)) <AVAudioPlayerDelegate>
